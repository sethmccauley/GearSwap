...
function init_gear_sets()
    ...
    -- Learning Set
    	sets.LearnMode = {ammo="Mavi Tathlum",
	...
	sets.precast.FC = {ammo="Sapience Orb",
		...
		back=Rosmerta.INT,waist="Witful Belt",legs="Psycloth Lappas",feet="Carmine Greaves"}
	...
	sets.precast.WS['Requiescat'] = set_combine(sets.precast.WS, {ear1="Moonshade Earring",ear2="Brutal Earring",hands="Leyline Gloves",ring1="Leviathan Ring",waist="Fotia Belt",legs="Samnuha Tights",feet=gear.HerculeanBootsAcc})
	sets.precast.WS['Realmrazer'] = set_combine(sets.precast.WS, {
		head="",neck="Fotia Gorget",ear1="Brutal Earring",ear2="Lifestorm Earring",
		body="Luhlaza Jubbah +1",hands="Qaaxo Mitaines",ring2="Regal Ring",ring2="Leviathan Ring",
		waist="Fotia Belt",legs="Quiahuiz Trousers",feet="Assimilator's Charuqs +1"})
	sets.precast.WS['Circle Blade'] = set_combine(sets.precast.WS, {ear1="Moonshade Earring",ear2="Brutal Earring",waist="Fotia Belt"})
	...
	sets.precast.WS['Chant du Cygne'] = set_combine(sets.precast.WS, 
		{ammo="Jukukik Feather",head="Adhemar Bonnet",neck="Fotia Gorget",ear1="Moonshade Earring",ear2="Brutal Earring",
	...
	body=gear.HerculeanBodyWS,hands=gear.HerculeanHandsWS,ring1="Hetairoi Ring",ring2="Epona's Ring",
	...
	sets.precast.WS['Sanguine Blade'] = {ammo="Pemphredo Tathlum",
		...
		body="Samnuha Coat",hands="Jhakri Cuffs +2",ring1="Acumen Ring",ring2="Archon Ring",
		back="Cornflower Cape",waist="Eschan Stone",legs="Amalric Slops",feet=gear.HerculeanBootsMAB}
	sets.precast.WS['Flash Nova'] = set_combine(sets.precast.WS['Sanguine Blade'], {head=gear.HerculeanHelmMAB,ring2="Strendu Ring"})
    
    
	-- Midcast Sets
	sets.midcast.FastRecast = {
		head="Carmine Mask",neck="",ear1="Etiolation Earring",ear2="Loquacious Earring",
	...
	sets.midcast['Blue Magic'].Healing = {
		...
		back="Cornflower Cape",waist="Gishdubar Sash",legs="Gyve Trousers",feet="Medium's Sabots"}
	...
	sets.engaged.DW.MaxHaste = {ammo="Ginsen",
		head="Adhemar Bonnet",neck="Ainia Collar",ear1="Dedition Earring",ear2="Cessance Earring",
		body="Adhemar Jacket",hands="Adhemar Wristbands +1",ring1="Petrov Ring",ring2="Epona's Ring",
		back=Rosmerta.DEX,waist="Windbuffet Belt +1",legs="Samnuha Tights",feet=gear.HerculeanBootsTA}
	sets.engaged.DW.Acc.MaxHaste = set_combine(sets.engaged.DW.MaxHaste, {ammo=Ginsen,head="Carmine Mask",neck="Ej Necklace",hands="Adhemar Wristbands"})
	sets.engaged.DW.Acc2.MaxHaste = set_combine(sets.engaged.DW.Acc.MaxHaste, {ear1="Zennaroi Earring",ear2="Cessance Earring",ring1="Patricius Ring",ring2="Regal Ring",waist="Olseni Belt",legs="Carmine Cuisses"})
