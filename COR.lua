...
function init_gear_sets()
	...
	body="Adhemar Jacket",hands="Chasseur's Gants",ring1="Persis Ring",
	back="Camulus's Mantle",waist="Reiki Yotai",legs="Desultor Tassets",feet="Pursuer's Gaiters"}
	
	sets.precast.JA['Double-Up'] = set_combine(sets.precast.CorsairRoll, {head="Lanun Tricorne +1",neck="Regal Necklace",hands="Chasseur's Gants"})
    ...
    sets.precast.FC = {
		...
		waist="Hurch'lan Sash",legs="Blood Cuisses",feet="Carmine Greaves"}
	...
	sets.midcast.CorsairShot['Light Shot'] = {ammo=gear.QDbullet,
		...
		body="Mummu Jacket +2",hands="Mummu Wrists +1",ring1="Weatherspoon Ring",ring2="Sangoma Ring",
		back=Camulus.MAtk,waist="Eschan Stone",legs="Mummu Kecks +2",feet="Mummu Gamashes +1"}
	...
	sets.idle = {main="",ammo=gear.RAbullet,
		head="Lanun Tricorne +1",neck="Sanctity Necklace",ear1="Impregnable Earring",ear2="Etiolation Earring",
		body="Mekosuchinae Harness",hands=gear.HerculeanHandsRefresh,ring1="Defending Ring",ring2="Roller's Ring",
		back="Shadow Mantle",waist="Flume Belt",legs=gear.HerculeanLegsRefresh,feet=gear.HerculeanBootsDT}
