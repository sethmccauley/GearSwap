...
function user_setup()
	...
	send_command('bind @1 gs c cycle CastingMode')
...
function init_gear_sets()
	...
	sets.precast.Step = {ammo="Yamarang",
		head="Mummu Bonnet +1",neck="Moonbeam Nodowa",ear1="Zennaroi Earring",ear2="Dignitary's Earring",
	...
	back=Andartia.INT,legs="Arjuna Breeches",}
	
	sets.precast.FC.ElementalNinjutsuSan = set_combine(sets.precast.FC, {feet="Mochizuki Kyahan +2"})
	sets.precast.FC.Utsusemi = set_combine(sets.precast.FC, {ammo="Impatiens",neck="Magoraga Beads",body="Mochizuki Chainmail +1",back=Andartia.INT,feet="Iga Kyahan +2"})
    ...
    sets.midcast.Ninjutsu = {ammo="Yamarang",
        ...
        body="Mummu Jacket +2",hands=gear.HerculeanHandsMacc,ring1="Regal Ring",ring2="Weather. Ring",
	...
	head=gear.HerculeanHelmMAB,neck="Orunmila's Torque",ear1="Loquacious Earring",ear2="Etiolation Earring",
	body=gear.TaeonBodyFC,hands="Leyline Gloves",ring1="Kishar Ring",ring2="Weatherspoon Ring",
	back=Andartia.INT,waist="Hurch'lan Sash",legs="Arjuna Breeches",feet="Taeon Boots"})
	
	sets.midcast.Utsusemi = set_combine(sets.midcast.SelfNinjutsu, {ammo="Impatiens",back=Andartia.INT,feet="Iga Kyahan +2"})
	...
	sets.MEva = {ammo="Staunch Tathlum",
		head="Mummu Bonnet +1",neck="Warder's Charm +1",ear1="Eabani Earring",ear2="Flashward Earring",
		body="Kendatsuba Samue",hands="Leyline Gloves",ring1="Vengeful Ring",ring2="Purity Ring",
	...
	sets.engaged = {ammo="Seki Shuriken",
		...
		back=Andartia.DEX,waist="Reiki Yotai",legs="Samnuha Tights",feet="Hizamaru Sune-Ate +1"}
	...
	sets.engaged.MaxHaste = {ammo="Seki Shuriken",
		head="Adhemar Bonnet",neck="Moonbeam Nodowa",ear1="Dedition Earring",ear2="Cessance Earring",
		body="Kendatsuba Samue",hands="Adhemar Wristbands +1",ring1="Petrov Ring",ring2="Epona's Ring",
	...
	-- DW Total in Gear: 5 DW
    sets.engaged.Acc2.MaxHaste = set_combine(sets.engaged.Acc.MaxHaste, {head="Mummu Bonnet +1",ear1="Zennaroi Earring",ring1="Patricius Ring",body="Adhemar Jacket",})
	...
	-- DW Total in Gear: 20 DW
	sets.engaged.Acc3.Haste_15 = set_combine(sets.engaged.Acc2.Haste_15, {ear1="Cessance Earring",hands="Ryuo Tekko",ring2="Ramuh Ring",waist="Olseni Belt"})
	...
	sets.precast.WS = {ammo="Seething Bomblet +1",
		head="Hachiya Hatsuburi +3",neck="Moepapa Medal",ear1="Brutal Earring",ear2="Cessance Earring",
	...
	body=gear.HerculeanVestAcc,hands="Ryuo Tekko",ring1="Ilabrat Ring",ring2="Begrudging Ring",
	back=Andartia.STR,waist="Windbuffet Belt +1",legs="Samnuha Tights",feet=gear.HerculeanBootsTA})
	...
	sets.precast.WS['Blade: Metsu'] = set_combine(sets.precast.WS['Blade: Ten'], {ear1="Ishvara Earring",ear2="Cessance Earring",ring1="Regal Ring",ring2="Ilabrat Ring",ammo="Jukukik Feather",back=Andartia.DEX})
	...
	head="Hachiya Hatsuburi +3",neck="Fotia Gorget",ear1="Moonshade Earring", ear2="Cessance Earring",
	body="Adhemar Jacket",hands="Adhemar Wristbands +1",ring1="Regal Ring",ring2="Ilabrat Ring",
	...
	sets.precast.WS['Evisceration'] = set_combine(sets.precast.WS['Blade: Hi'], {head="Mummu Bonnet +1",
